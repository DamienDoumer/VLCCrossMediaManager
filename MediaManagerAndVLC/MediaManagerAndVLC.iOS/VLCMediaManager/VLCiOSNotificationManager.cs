...
{
    public class VLCiOSNotificationManager : NotificationManagerBase
    {
        public VLCiOSNotificationManager()
        {
            Enabled = true;
        }
        ...
        //Where notification controls are managed
